...
int main()
{
    ...
    string s1 = "I am waiting for summer.";
    string s2 = "I've been waiting for summer.";
    cout<<"Original text: I am waiting for summer."<< endl;
    cout<<"Edited text: I've been waiting for summer."<< endl;
    cout<<"Expected result: I waiting for summer."<< endl;

    string memo [100][100];

    string s3 = LCS(s1,s2,0,0, memo);

    cout<<" result: "<<LCS(s1,s2,0,0, memo)<< endl;
